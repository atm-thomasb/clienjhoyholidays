...
class modCliEnjoyHolidays extends DolibarrModules
{
	...
	public function __construct($db)
	{
		...
		$this->export_sql_end[$r]  =' FROM '.MAIN_DB_PREFIX.'formuledevoyage as t';
	...
	public function init($options = '')
	{
		...
		$result1=$extrafields->addExtraField('clienjoyholidays_note', "Mention spécifique", 'text', 1,  3, 'propal',   0, 0, '', 'a:1:{s:7:"options";a:1:{s:0:"";N;}}', 1, '', 0, 0, '', '', 'clienjoyholidays@clienjoyholidays', 'isModEnabled("clienjoyholidays")');
		$result2=$extrafields->addExtraField('clienjoyholidays_manager', "Responsable", 'sellist', 2, 10, 'propaldet',      0, 0, '', 'a:1:{s:7:"options";a:1:{s:20:"user:firstname:rowid";N;}}', 1, '', 0, 0, '', '', 'clienjoyholidays@clienjoyholidays', 'isModEnabled("clienjoyholidays")');
