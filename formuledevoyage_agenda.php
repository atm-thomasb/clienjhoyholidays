...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->clienjoyholidays->multidir_output[!empty($object->entity) ? $object->entity : $conf->entity]."/".$object->id;
}
...
if ($object->id > 0) {
	...
	llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-clienjoyholidays page-card_agenda');
	...
	if (isModEnabled('agenda') && ($user->hasRight('agenda', 'myactions', 'read') || $user->hasRight('agenda', 'allactions', 'read'))) {
		...
		//$cachekey = 'count_events_formuledevoyage_'.$object->id;
