# CLIENJOYHOLIDAYS FOR [DOLIBARR ERP CRM](https://www.dolibarr.org)
...
<!--
![Screenshot clienjoyholidays](img/screenshot_clienjoyholidays.png?raw=true "CliEnjoyHolidays"){imgmd}
-->
...
```sh
cd ....../custom
git clone git@github.com:gitlogin/clienjoyholidays.git clienjoyholidays
```
