...
foreach ($linkedObjectBlock as $key => $objectlink) {
	...
	echo '<td class="linkedcol-element tdoverflowmax100">'.$langs->trans("FormuleDeVoyage");
	...
	echo '<td class="linkedcol-date center">'.dol_print_date($objectlink->date_departure, 'day').'</td>';
	echo '<td class="linkedcol-amount right">';
	if ($user->hasRight('clienjoyholidays', 'formuledevoyage', 'read')) {
		$total = $total + $objectlink->cost;
		echo price($objectlink->cost);
	}
	echo '</td>';
