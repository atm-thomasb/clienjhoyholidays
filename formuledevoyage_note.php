...
$langs->loadLangs(array("clienjoyholidays@clienjoyholidays", "companies"));
...
if ($id > 0 || !empty($ref)) {
	$upload_dir = $conf->clienjoyholidays->multidir_output[empty($object->entity) ? $conf->entity : $object->entity]."/".$object->id;
}
...
llxHeader('', $title, $help_url, '', 0, 0, '', '', '', 'mod-clienjoyholidays page-card_notes');
